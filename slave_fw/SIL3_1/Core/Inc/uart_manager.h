...
/* --- Funkcje interfejsu --- */
void UARTM_Init(UART_Manager_t *u, UART_HandleTypeDef *huart, UART_Backend_t backend, UART_Mode_t mode, bool echo);
...
void UARTM_IRQHandler(UART_Manager_t *u);	// wywoływana w HAL_UART_RxCpltCallback
