...
bool MC_CheckResponse(uint8_t *response); // Teraz kompilator będzie wiedział co to bool
void MC_IRQHandler(UART_HandleTypeDef *huart); // Upewnij się, że ten prototyp też tu jest
